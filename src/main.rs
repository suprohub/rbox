...
async fn main() {
    ...
    sorted.insert(0, (format!("ss://bm9uZTpjYWFjYmJhLWJhY2EtY2FiYS1kY2FiLWJjYmFhY2NhYmJjYQ==@127.0.0.1:1080#GENERATED BY RBOX 🔄 LATEST-UPDATE 📅 {current_time}"), 0));
